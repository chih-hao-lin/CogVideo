#!/bin/sh
#
#SBATCH --job-name=kid_game_bear
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_kid_game_bear.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_kid_game_bear.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/kid_game_bear
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/kid_game/kid_game.mp4
PROMPT="Add a teddy bear on the left of the kid"
PROMPT_ORIG="[semantic] kid"
PROMPT_EDIT="[semantic] bear"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/kid_game_bear.sh $DIR_SAMPLE
NUM_SAMPLES=250
