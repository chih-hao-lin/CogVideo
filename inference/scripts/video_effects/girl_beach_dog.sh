#!/bin/sh
#
#SBATCH --job-name=girl_beach_dog
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_girl_beach_dog.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_girl_beach_dog.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/girl_beach_dog
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/girl_beach/girl_beach.mp4
PROMPT="Add a puppy running beside the woman"
PROMPT_ORIG="[semantic] woman"
PROMPT_EDIT="[semantic] puppy"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/girl_beach_dog.sh $DIR_SAMPLE
NUM_SAMPLES=250
