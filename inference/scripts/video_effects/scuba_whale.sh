#!/bin/sh
#
#SBATCH --job-name=scuba_whale
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_scuba_whale.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_scuba_whale.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/scuba_whale
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/scuba/scuba.mp4
PROMPT="Add a majestic whale in the background"
PROMPT_ORIG="[semantic] diver"
PROMPT_EDIT="[semantic] whale"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/scuba_whale.sh $DIR_SAMPLE
NUM_SAMPLES=250
