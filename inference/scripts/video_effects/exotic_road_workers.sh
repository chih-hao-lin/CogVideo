#!/bin/sh
#
#SBATCH --job-name=exotic_road_workers
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_exotic_road_workers.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_exotic_road_workers.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/exotic_road_workers
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/exotic_road/exotic_road.mp4
PROMPT="Add many workers in the rice field, cutting crops"
PROMPT_ORIG="[semantic] road"
PROMPT_EDIT="[semantic] workers"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/exotic_road_workers.sh $DIR_SAMPLE
NUM_SAMPLES=250
