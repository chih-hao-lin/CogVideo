#!/bin/sh
#
#SBATCH --job-name=girl_living_room_bear
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_girl_living_room_bear.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_girl_living_room_bear.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/girl_living_room_bear
...
PROMPT="Add a bear dancing at the left of the woman"
PROMPT_ORIG="[semantic] woman"
PROMPT_EDIT="[semantic] bear"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=2
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/girl_living_room_bear.sh $DIR_SAMPLE
NUM_SAMPLES=250
