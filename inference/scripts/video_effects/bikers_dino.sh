...
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_bikers_dino.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_bikers_dino.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/bikers_dino
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/bikers/bikers.mp4
PROMPT="Add dinosaurs eating leaves from trees, taking big bites"
PROMPT_ORIG="[semantic] bikers"
PROMPT_EDIT="[semantic] dinosaurs"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=1
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/bikers_dino.sh $DIR_SAMPLE
NUM_SAMPLES=250
