#!/bin/sh
#
#SBATCH --job-name=beagle_dragon
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_beagle_dragon.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_beagle_dragon.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/beagle_dragon
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/beagle/beagle.mp4
PROMPT="Add a fire breathing dragon chasing the dog"
PROMPT_ORIG="[semantic] dog"
PROMPT_EDIT="[semantic] dragon"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/beagle_dragon.sh $DIR_SAMPLE
NUM_SAMPLES=250
