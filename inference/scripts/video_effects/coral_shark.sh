#!/bin/sh
#
#SBATCH --job-name=coral_shark
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_coral_shark.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_coral_shark.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/coral_shark
...
PROMPT="Add a group of sharks swimming in the background"
PROMPT_ORIG="[semantic] coral"
PROMPT_EDIT="[semantic] sharks"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=1
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/coral_shark.sh $DIR_SAMPLE
NUM_SAMPLES=250
