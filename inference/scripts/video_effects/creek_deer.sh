#!/bin/sh
#
#SBATCH --job-name=creek_deer
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_creek_deer.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_creek_deer.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/creek_deer
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/creek/creek.mp4
PROMPT="Add a pair of deer drinking water from the creek"
PROMPT_ORIG="[semantic] creek"
PROMPT_EDIT="[semantic] deers"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=1
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/creek_deer.sh $DIR_SAMPLE
NUM_SAMPLES=250
