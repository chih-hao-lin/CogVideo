#!/bin/sh
#
#SBATCH --job-name=box_puppy
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_box_puppy.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_box_puppy.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/box_puppy
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/box/box.mp4
PROMPT="Add a puppy peaking its head out of the box"
PROMPT_ORIG="[semantic] box"
PROMPT_EDIT="[semantic] puppy"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/box_puppy.sh $DIR_SAMPLE
NUM_SAMPLES=250
