#!/bin/sh
#
#SBATCH --job-name=dancer_audience
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_dancer_audience.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_dancer_audience.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/dancer_audience
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/dancer_stage/dancer_stage.mp4
PROMPT="Add audiences in the seats"
PROMPT_ORIG="[semantic] dancer"
PROMPT_EDIT="[semantic] audience"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/dancer_audience.sh $DIR_SAMPLE
NUM_SAMPLES=250
