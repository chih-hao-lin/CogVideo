#!/bin/sh
#
#SBATCH --job-name=jogging_river_golden
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_jogging_river_golden.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_jogging_river_golden.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/jogging_river_golden
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/jogging_river/jogging_river.mp4
PROMPT="Add a playful golden retriever swimming trying to catch up with the joggers"
PROMPT_ORIG="[semantic] joggers"
PROMPT_EDIT="[semantic] dog"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/jogging_river_golden.sh $DIR_SAMPLE
NUM_SAMPLES=250
