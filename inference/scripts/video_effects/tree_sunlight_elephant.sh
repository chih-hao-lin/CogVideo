#!/bin/sh
#
#SBATCH --job-name=tree_sunlight_elephant
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_tree_sunlight_elephant.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_tree_sunlight_elephant.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/tree_sunlight_elephant
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/tree_sunlight_2/tree_sunlight_2.mp4
PROMPT="Add a elephant walking"
PROMPT_ORIG="[semantic] trees"
PROMPT_EDIT="[semantic] elephant"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=1
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/tree_sunlight_elephant.sh $DIR_SAMPLE
NUM_SAMPLES=250
