#!/bin/sh
#
#SBATCH --job-name=taxi_tsunami
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_taxi_tsunami.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_taxi_tsunami.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/taxi_tsunami
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/taxi/taxi.mp4
PROMPT="Add a massive tsunami flooding the city, water everywhere, apocalyptic"
PROMPT_ORIG="[semantic] car"
PROMPT_EDIT="[semantic] water"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=1
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/taxi_tsunami.sh $DIR_SAMPLE
NUM_SAMPLES=250
