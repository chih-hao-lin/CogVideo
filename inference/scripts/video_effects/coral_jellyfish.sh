#!/bin/sh
#
#SBATCH --job-name=coral_jellyfish
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_coral_jellyfish.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_coral_jellyfish.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/coral_jellyfish
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/coral/coral.mp4
PROMPT="Add a group of jellyfish floating"
PROMPT_ORIG="[semantic] coral"
PROMPT_EDIT="[semantic] jellyfish"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/coral_jellyfish.sh $DIR_SAMPLE
NUM_SAMPLES=250
