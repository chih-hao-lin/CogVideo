#!/bin/sh
#
#SBATCH --job-name=wis_trees_dinosaur
#SBATCH --output=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_wis_trees_dinosaur.out
#SBATCH --error=/work/hdd/benk/cl121/CogVideo/inference/outputs/logs/%j_wis_trees_dinosaur.err
#
...
DIR_OUTPUT=$DIR_DYNVFX/outputs/dynvfx_sem/wis_trees_dinosaur
PATH_PROMPT=$DIR_OUTPUT/vlm_agent.json
PATH_LATENT=$DIR_OUTPUT/inversion.pt
PATH_VIDEO=/work/hdd/benk/cl121/dynvfx.github.io/sm/assets/results_f9/wis_trees/wis_trees.mp4
PROMPT="Add a dinosaur walking on the road"
PROMPT_ORIG="[semantic] road"
PROMPT_EDIT="[semantic] dinosaur"
PATH_MASK_ORIG=$DIR_OUTPUT/mask_orig.mp4
SEED=0
DIR_SAMPLE=$DIR_OUTPUT/sampling_0_seed_$SEED
mkdir -p $DIR_SAMPLE
cp $DIR_DYNVFX/scripts/video_effects/wis_trees_dinosaur.sh $DIR_SAMPLE
NUM_SAMPLES=250
